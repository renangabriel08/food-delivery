...
<div id='projeto'>
  ...
  Aplicativo desenvolvido em flutter para aprimoramento no desenvolvimento de layouts mobile. Consiste em apenas telas visuais, sem aplicação de funcionalidades
</div>
